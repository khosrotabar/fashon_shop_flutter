...
import 'package:fashon_shop/src/cart/hooks/results/cart_results.dart';
...
FetchCart fetchCart() {
  ...
  return FetchCart(cart: cart.value, isLoading: isLoading.value, error: error.value, refetch: refetch);
}
