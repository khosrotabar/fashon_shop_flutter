...
import 'package:fashon_shop/src/cart/models/cart_model.dart';
import 'package:fashon_shop/src/cart/widgets/cart_counter.dart';
import 'package:fashon_shop/src/cart/widgets/update_button.dart';
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        cartNotifier.selectedCart != null && cartNotifier.selectedCart == cart.id
                            ? const CartCounter()
                            : GestureDetector(
                                onTap: () {
                                  cartNotifier.setSelectedCounter(cart.id, cart.quantity);
                                },
                                onDoubleTap: () {},
                                child: Container(
                                  width: 40.w,
                        ...
                        cartNotifier.selectedCart != null && cartNotifier.selectedCart == cart.id
                            ...
                            : Padding(
                                padding: const EdgeInsets.only(right: 6.0),
                                child: ReusableText(
                                  text: '\$ ${(cart.quantity * cart.product.price).toStringAsFixed(2)}',
